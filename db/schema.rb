...
ActiveRecord::Schema.define(version: 20170213171825) do
  ...
  create_table "sheets", id: :uuid, default: "uuid_generate_v4()", force: :cascade do |t|
  ...
  create_table "worksheet_rows", force: :cascade do |t|
